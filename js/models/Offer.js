class Offer{
    constructor (codigo_produto, codigo_barras, nome_comercial, dosagem, unidade_medida, conteudo, tipo, estado_ativo, principio_ativo, 
        ...
        controlado, desconto, lucro, tipo_item, estoque, lote, comissão, publicar_em, valido_ate, observacoes, photo){
        ...
        this._publicar_em = publicar_em;
        this._valido_ate = valido_ate;
    ...
    get publicar_em(){
        ...
        return this._publicar_em;
    
    }

    get valido_ate(){
    
        return this._valido_ate;
    ...
    getNewID(){
        ...
        let offersID = parseInt(localStorage.getItem("offersID"));

        if (!offersID) offersID = 0;

        offersID++;

        localStorage.setItem("offersID", offersID);
    ...
    save(){
        ...
        let offers = Offer.getOffersStorage();
