...
class cadastrarNovaLoja{
    constructor(cnpj, ie, razaoSocial, nomeFantasia, horario_abertura_loja, horario_fechamento_loja, vinculo_loja, loja_vinculada, cep, endereco, numero, complemento, bairro, cidade, estado  ){
        this.cnpj = cnpj
        this.ie = ie
        ...
        this.vinculo_loja = vinculo_loja
        this.loja_vinculada = loja_vinculada
        this.cep = cep
        this.endereco = endereco
        this.numero = numero
...
function cadastrarLoja(){
    ...
    let vinculo_loja = document.getElementById('vinculo_loja')
    let loja_vinculada = document.getElementById('loja_vinculada')
...
class novaPesquisa{
    constructor(input_pesquisa){
        this.input_pesquisa = input_pesquisa
...
function pesquisarProdutos(){
    let input_pesquisa = document.getElementById('input_pesquisa')
   

    let pesquisarProdutos = new novaPesquisa(
